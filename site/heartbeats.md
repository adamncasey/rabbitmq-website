...
The broker gives a suggested heartbeat timeout value when the client connects.
The client can ignore this suggestion. Any heartbeat timeout value sent by the client is
